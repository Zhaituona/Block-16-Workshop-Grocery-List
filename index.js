...
function getItemPriceByName(name) {
  ...
  return item ? item.price : null; // Return null if the item is not found
}

console.log(getItemPriceByName("apple"));
console.log(getItemPriceByName("Avocado"));

/**
 * @param {number} categoryId - ID of category to find
...
function calculateTotalCartPrice() {
  ...
  return cart.reduce((totalPrice, item) => totalPrice + (item.price * item.inventory), 0);
}
